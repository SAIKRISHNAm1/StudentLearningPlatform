...
<html>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top ">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <!-- Register Button -->
      <a href="studentPortal.jsp" class="btn btn-success my-2 my-sm-0">Portal</a>
    </div>
  </nav>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<form name="registration" method="post" action="UpdateController" class="form-group">
						...
						<div class="row">
							<div class="col-md-12">
								<input type="text" name="fullname" id="fullname" placeholder="Enter Fullname" class="form-control">
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
